"use client"
import React, { useEffect } from "react" // Importei useEffect
...
import ScrollReveal from 'scrollreveal' // Importei a biblioteca de animação
...
export default function PsicologosLandingPage() {
  ...
  const WHATSAPP_URL = `https://api.whatsapp.com/send/?phone=5548988267221&text=${encodeURIComponent(WHATSAPP_MESSAGE)}&type=phone_number&app_absent=0`;
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      {/* Componente 2: A Agitação do Problema */}
      ...
      {/* Componente 3: A Revelação da Solução */}
      ...
      {/* Componente 4: Prova Social Irrefutável */}
