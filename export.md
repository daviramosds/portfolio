...
**Data de geração**: 10/10/2025 às 18:16:58  

**Timestamp ISO**: `2025-10-10T18:16:58.634978`
...
<details><summary>Clique para ver o conteúdo de `globals.css`</summary>
...
/* Animações básicas de scroll simplificadas */
.scroll-animate {
  opacity: 0;
...
/* Animações stagger simples para elementos filhos */
.stagger-child {
  opacity: 0;
...
/* Button hover transitions - more specific */
button {
  transition: all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
button:hover {
...
/* Specific hover states with transitions */
...
/* Ensure all Tailwind hover utilities have transitions */
[class*="hover:"]:not([class*="transition"]):not([class*="duration"]) {
  transition: all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
/* Card highlight para navegação */
.card-highlight {
...
/* Animação gradual para o nome Davi Ramos */
.name-split-hover {
  display: inline-block;
  transition: transform 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
.name-split-hover:hover {
  transform: scale(1.05);
}
.name-first {
...
.name-split-hover:hover .name-first {
  transform: translateY(-2px);
  text-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
}
.name-split-hover:hover .name-last {
  transform: translateY(-2px);
  text-shadow: 0 4px 8px rgba(59, 130, 246, 0.2);
}
.dark .name-split-hover:hover .name-first {
  text-shadow: 0 4px 8px rgba(255, 255, 255, 0.1);
}
/* Gradient animation for the name */
@keyframes gradient {
  0%,
  100% {
...
/* Added blinking animation for the green availability dot */
@keyframes pulse-dot {
  0%,
  100% {
    opacity: 1;
...
/* Scrollbar personalizada com cor azul */
::-webkit-scrollbar {
  width: 8px;
  height: 8px;
}
...
html {
  ...
  scrollbar-color: #3b82f6 var(--background);
}
          ...
          <div className="space-y-6 sm:space-y-8 lg:pr-8 hero-content order-2 lg:order-1">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight hero-name leading-tight">
                <span className="bg-gradient-to-r from-foreground via-[
                  Davi Ramos
                </span>
              </h1>
              <div className="space-y-1">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[
                  {t("hero.title")}
                </h2>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="hover:scale-110 transition-all duration-300 hover:text-[
                    asChild
                  >
          ...
          <div className="relative hero-image order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 bg-card border rounded-lg p-2 sm:p-4 shadow-lg backdrop-blur-sm z-50">
                <div className="text-lg sm:text-2xl font-bold text-[
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={service.id}
                id={service.id}
                className="bg-card border rounded-xl p-8 hover:shadow-xl transition-all duration-500 group hover:border-[
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-[
                    <service.icon className="h-6 w-6 text-[
                  </div>
            ...
            {[
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-xl font-semibold mb-2 flex-shrink-0 group-hover:text-[
                    {project.title}
                  </h3>
                  ...
                  <div className="mt-auto flex-shrink-0">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="group/btn cursor-pointer w-full justify-center hover:bg-[
                      asChild
                    >
              ...
              <div className="space-y-8 contact-info">
                {[
                  ...
                  <div key={index} className="flex items-start gap-4 contact-item">
                    <div className="w-12 h-12 bg-[
                      <item.icon className="h-6 w-6 text-[
                    </div>
                    <div>
...
<details><summary>Clique para ver o conteúdo de `components.json`</summary>
    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="fixed top-4 right-16 z-50 hover:scale-110 transition-all duration-300 hover:text-[
        >
      ...
      <DropdownMenuContent align="end" className="min-w-[100px]" onCloseAutoFocus={(e) => e.preventDefault()}>
        <DropdownMenuItem
          ...
          className={`cursor-pointer ${language === "en" ? "bg-[
        >
        ...
        <DropdownMenuItem
          ...
          className={`cursor-pointer ${language === "pt" ? "bg-[
        >
          <span className="mr-2">🇧🇷</span>
          PT
        </DropdownMenuItem>
...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="fixed top-4 right-4 z-50 hover:scale-110 transition-all duration-300 hover:text-[
    >
...
const alertVariants = cva(
  "relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(
  {
    variants: {
      variant: {
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "w-full flex items-center text-sm font-medium justify-center h-(
  ...
  return (
    <HoverCardPrimitive.Portal data-slot="hover-card-portal">
      <HoverCardPrimitive.Content
        ...
        sideOffset={sideOffset}
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-64 origin-(
          className
        )}
        {...props}
      />
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(
          className
        )}
        {...props}
      />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-(
          position === "popper" &&
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar text-sidebar-foreground flex h-full w-(
          className
        )}
        {...props}
      >
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(
            : "group-data-[collapsible=icon]:w-(
          className
        )}
        {...props}
...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(
  {
    variants: {
      variant: {
...
<details><summary>Clique para ver o conteúdo de `package.json`</summary>
...
- **Arquivo ignorado**: `pnpm-lock.yaml` (Tamanho: 125.48 KB)
...
## public\file-automation-tool.png

- **Arquivo de mídia**: `file-automation-tool.png`


## public\microservices-architecture.png

- **Arquivo de mídia**: `microservices-architecture.png`


## public\og-image.jpg

- **Arquivo de mídia**: `og-image.jpg`


## public\placeholder-logo.png

- **Arquivo de mídia**: `placeholder-logo.png`


## public\placeholder-logo.svg

- **Arquivo de mídia**: `placeholder-logo.svg`


## public\placeholder-user.jpg

- **Arquivo de mídia**: `placeholder-user.jpg`


## public\placeholder.jpg

- **Arquivo de mídia**: `placeholder.jpg`


## public\placeholder.svg

- **Arquivo de mídia**: `placeholder.svg`


## public\profile.jpg

- **Arquivo de mídia**: `profile.jpg`
...
{
  "name": "Davi Ramos — Development • Automation • DevOps",
  "short_name": "Davi Ramos",
  "description": "Modern web development, process automation, and DevOps to turn ideas into reliable products.",
  "start_url": "/",
  "scope": "/",
  "display": "standalone",
...
- **Arquivo de mídia**: `socially.gif`


## README.md

<details><summary>Clique para ver o conteúdo de `README.md`</summary>
...
<details><summary>Clique para ver o conteúdo de `tsconfig.json`</summary>
...
## Sobre o Script de Geração (`main.py`)


Este arquivo Markdown foi gerado automaticamente...

Para incluir o código-fonte do próprio script (`main.py`) execute-o com a flag `--incluir-script`.